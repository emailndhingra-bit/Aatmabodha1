...
const oracle_rules_version_1 = require("../config/oracle-rules-version");
...
let GeminiService = class GeminiService {
    ...
    contextInstructionCacheKey(systemInstruction, userId, natalFingerprint) {
        ...
        const contentHash = (0, crypto_1.createHash)('sha256')
            ...
            .digest('hex')
            .substring(0, 16);
        const prefix = `${userId ?? 'anon'}\x1e${(natalFingerprint ?? '').trim()}\x1e${oracle_rules_version_1.ORACLE_RULES_VERSION}\x1e${contentHash}\x1e`;
    ...
    async chat(body, userId) {
        ...
        console.log('[OracleDiag] about to call Gemini', {
            ...
            rulesVersion: oracle_rules_version_1.ORACLE_RULES_VERSION,
